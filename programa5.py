# -*- coding: utf-8 -*-
"""
Created on Sat Mar 19 18:32:18 2022
...
"background-color:qlineargradient(spread:pad, x1:0.124, y1:0.153409, x2:1, y2:1, stop:0 rgba(29, 60, 195, 255), stop:1 rgba(255, 255, 255, 255));}")
        ...
        self.label.setGeometry(QtCore.QRect(360, 10, 732, 40))
        ...
        self.proces.setGeometry(QtCore.QRect(290, 140, 91, 31))
        ...
        self.iniciar.setGeometry(QtCore.QRect(60, 180, 321, 31))
...
"background-color: rgb(255, 255, 255);")
        ...
        self.label_11.setGeometry(QtCore.QRect(640, 360, 217, 31))
        self.label_11.setStyleSheet("font: 14pt \"Palatino Linotype\";")
        self.label_11.setObjectName("label_11")
        self.bloqueados = QtWidgets.QTableWidget(widget)
        self.bloqueados.setGeometry(QtCore.QRect(590, 400, 311, 231))
        ...
        self.Terminados.setGeometry(QtCore.QRect(1050, 140, 421, 381))
        ...
        self.label_13.setGeometry(QtCore.QRect(1180, 560, 57, 31))
        self.label_13.setStyleSheet("font: 14pt \"Palatino Linotype\";")
        self.label_13.setObjectName("label_13")
        self.reloj = QtWidgets.QLabel(widget)
        self.reloj.setGeometry(QtCore.QRect(1250, 560, 101, 31))
...
"background-color: rgb(255, 255, 255);")
    ...
    def retranslateUi(self, widget):
        ...
        self.label.setText(_translate("widget", "Algoritmo de planificación FCFS (First Come First Server)"))
    ...
    def ejecucion(self):
        ...
        if self.bandera == 2: #error
            ...
            lista.append(lista[6] - lista[5]) #retorno
            lista.append(self.lisd[6] - lista[5])  #respuesta
            lista.append(self.cont + 1)  #servicio
            lista.append(lista[7]-lista[9] + 1) #espera
            lista.append(lista[4]-lista[9]) #restante
